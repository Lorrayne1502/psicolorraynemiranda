                ...
                if (postId === 7) {
                  return (
                    <>
                      ...
                      <p>
                        No último dia 7 de setembro, participei de uma caminhada organizada pelo CAPS (Centro de Atenção Psicossocial), 
                        que trouxe como tema a importância do cuidado em saúde mental. Mais do que um ato público, esse encontro foi 
                        um espaço de sensibilização e reflexão coletiva sobre a vida e a necessidade de acolhimento integral.
                      </p>
                      
                      <p>
                        Durante a caminhada, segurei uma placa com uma frase de Carl Rogers, que expressa muito daquilo em que acredito:
                      </p>
                      
                      <blockquote>
                        <p>
                          "O ser humano possui um importante valor... Por mais que o rotulem e avaliem, ele continua sendo, 
                          acima de tudo, uma pessoa."
                        </p>
                      </blockquote>
                      
                      <p>
                        Para mim, essa mensagem representa o que o cuidado em saúde mental deve sempre preservar: 
                        a dignidade e a singularidade de cada ser humano.
                      </p>
                      
                      <h2>Saúde mental como direito de todos</h2>
                      <p>
                        O CAPS tem um papel essencial na rede pública de atenção à saúde, promovendo cuidado contínuo e comunitário. 
                        Ao caminhar junto de tantas pessoas que acreditam na importância da prevenção, da escuta e do acolhimento, 
                        senti o quanto precisamos fortalecer cada vez mais esse trabalho.
                      </p>
                      
                      <p>
                        Falar sobre saúde mental não pode se restringir apenas ao consultório ou às datas oficiais, mas precisa 
                        estar presente no dia a dia da sociedade, na forma como nos relacionamos e nas políticas públicas que 
                        garantem acesso e cuidado para todos.
                      </p>
                      
                      <h2>Democracia e cuidado integral</h2>
                      <p>
                        Essa caminhada também me levou a refletir sobre a influência da democracia na construção de uma sociedade 
                        que valoriza a saúde mental. É por meio da democracia que conquistamos direitos e garantimos políticas 
                        públicas que promovem cuidados integrais, acessíveis e humanizados.
                      </p>
                      
                      <p>
                        Sem democracia, corremos o risco de perder avanços que asseguram não apenas o tratamento, mas também a 
                        promoção da vida em comunidade, o acesso universal ao cuidado e a proteção social. A saúde mental precisa 
                        ser vista como uma pauta coletiva, e não apenas individual.
                      </p>
                      
                      <h2>Um compromisso que se renova</h2>
                      <p>
                        Estar presente nessa caminhada, com minha placa e minha voz, foi uma forma de reafirmar meu compromisso 
                        como psicóloga clínica e como cidadã. Acredito que cada gesto, cada ato público e cada espaço de diálogo 
                        contribui para uma cultura de valorização da vida.
                      </p>
                      
                      <p>
                        Que possamos seguir juntos, unindo forças em defesa da saúde mental, da democracia e da dignidade de cada pessoa.
                      </p>
                    </>
                  );
                }
